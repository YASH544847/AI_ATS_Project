...
st.set_page_config(layout="wide", page_title="AI-ATS Interview Predictor 🤖")
...
with st.sidebar:
    ...
    st.markdown("---")
    with st.expander("💡 Available Companies for Reference"): # Expander for company list
